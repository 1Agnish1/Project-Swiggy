...
import { addRestaurants } from "../Stored/restaurantSlice";

export default function Restaurant() {
  const dispatch = useDispatch();

  const RestData = useSelector((store) => store.restaurant.restaurantList);

  useEffect(() => {
    // If restaurants already exist in redux
