...
function RestaurantMenu() {
  ...
  return (
    <div>
      ...
      <div className="w-[80%] mx-auto mt-20 mb-20">
        <button
          className={`text-2xl py-2 px-8 border rounded-2xl mr-4 ${selected === "veg" ? "bg-green-600" : "bg-gray-300"}`}
          onClick={() => setSelected(selected === "veg" ? null : "veg")}
        >
          Veg
        </button>
        <button
          className={`text-2xl py-2 px-4 border rounded-2xl  ${selected === "non-veg" ? "bg-red-600" : "bg-gray-300"}`}
